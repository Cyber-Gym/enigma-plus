...
DATASET_NAME=$1
DATASET_JSON="/mnt/people/zhuoterq/ctf-gym/${DATASET_NAME}.json"
...
run_challenge() {
    ...
    local DATA_PATH="/mnt/people/zhuoterq/ctf-gym/${challenge_path}/challenge.json"
    local REPO_PATH="/mnt/people/zhuoterq/ctf-gym/${challenge_path}/"
